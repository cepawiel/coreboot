...
const u32 cim_verb_data[] = {
	0x10ec0294,	/* Codec Vendor / Device ID: Realtek ALC294 */
	0x17aa310b,	/* Subsystem ID */
	15,		/* Number of 4 dword sets */
	AZALIA_SUBVENDOR(0, 0x17aa310b),
	...
	AZALIA_PIN_CFG(0, 0x1a, 0x02a19040),
	AZALIA_PIN_CFG(0, 0x1b, AZALIA_PIN_CFG_NC(0)),
	AZALIA_PIN_CFG(0, 0x1d, 0x4046bc05),
